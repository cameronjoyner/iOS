...
//  DesignCode
//
//  Created by Cameron Joyner on 7/3/20.
    ...
    var body: some View {
        ZStack {
            ...
            TitleView()
                ...
                .animation(
                    Animation //because of multiple animations
                        .default
                        .delay(0.1)
                        //.speed(2)
            ...
            CardView()
                ...
                .gesture(
                    ...
                    .onEnded { value in
                        self.viewState = .zero
                        self.show = false //on drag starts and ends animation
                    }
                )
            
            //Text("\(bottomState.height)").offset(y: -300)
            
            BottomCardView(show: $showCard) //connecting the binding
...
struct BottomCardView: View {
    ...
    @Binding var show: Bool // this allows us to change the ringview
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This is proof that Cameron Joyner received a certificate in UI Design")
            ...
            HStack(spacing: 20.0) {
                ...
                //parent animation applied to all the children of ring view

                VStack(alignment: .leading, spacing: 8) {
                    Text("SwiftUI")
                        .fontWeight(.bold)
                    Text("12 of 12 compelted \n 10 hours spent so far")
                        .font(.footnote)
